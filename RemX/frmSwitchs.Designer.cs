namespace RemXcs
{
    partial class frmSwitchs
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmSwitchs";
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.WindowsDefaultBounds;
            this.Text = "Актуальные переключения";
            this.Activated += new System.EventHandler(this.frmAlarms_Activated);
            this.Load += new System.EventHandler(this.frmSwitchs_Load);
            this.Shown += new System.EventHandler(this.frmSwitchs_Shown);
