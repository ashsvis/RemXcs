...
{
    public partial class frmAI : Form, IPointConnect
    {
        bool blink = false;
        ...
        public frmAI(Entity ent, ImportRealValues import, ExportRealValues export)
        {
            InitializeComponent();
            this.ent = ent;
            this.import = import;
        ...
        private void FirstLoad()
        {
            ...
            lbChannelNumber.Text = ent.Values["ChannelNumber"].ToString();
            lbParameter.Text = ent.Values["Parameter"].ToString();
        ...
        private void backgroundFetch_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            ...
            lbGroupFactTime.Text = (Reals.ContainsKey("Seconds")) ?
                Reals["Seconds"] : "------";
            lbChannelNumberReturn.Text = (Reals.ContainsKey("ChannelNumberReturn")) ?
                Reals["ChannelNumberReturn"] : "------";
            lbParameterReturn.Text = (Reals.ContainsKey("ParameterReturn")) ?
                Reals["ParameterReturn"] : "------";
            lbValueReturn.Text = (Reals.ContainsKey("ValueReturn")) ?
                Reals["ValueReturn"] : "------";
            lbEUDescReturn.Text = (Reals.ContainsKey("EUDescReturn")) ?
                Reals["EUDescReturn"] : "------";
            lbSnapTimeReturn.Text = (Reals.ContainsKey("SnapTimeReturn")) ?
                Reals["SnapTimeReturn"] : "------";
