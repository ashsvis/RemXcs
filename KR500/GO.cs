...
{
    public class GO : ClassPoint, IPointPlugin
    {
        ...
        public GO()
        {
            ...
            Add("PtType", "Тип точки", PropType.Invisible, "GO");
            Add("PtDesc", "Дескриптор позиции", PropType.String, "Группа опроса выходов алгоблока");
        ...
        public new string PluginShortType { get { return "GO"; } }

        public new string PluginDescriptor { get { return "Группа опроса выходов алгоблока"; } }

        public new Color GetIconColor { get { return Color.FromArgb(192, 192, 0); } }

        public new string[] GetFilterChildTypes { get { return new string[] { "AI", "DI" }; } }
