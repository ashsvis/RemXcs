...
{
    public class GP : ClassPoint, IPointPlugin
    {
        ...
        public GP()
        {
            ...
            Add("PtType", "Тип точки", PropType.Invisible, "GP");
            Add("PtDesc", "Дескриптор позиции", PropType.String, "Группа опроса параметров алгоблока");
        ...
        public new string PluginShortType { get { return "GP"; } }

        public new string PluginDescriptor { get { return "Группа опроса параметров алгоблока"; } }

        public new Color GetIconColor { get { return Color.FromArgb(192, 192, 0); } }

        public new string[] GetFilterChildTypes { get { return new string[] { "AP", "DP" }; } }
