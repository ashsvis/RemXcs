...
{
    public partial class frmFetchingKR500 : Form
    {
        ...
        public frmFetchingKR500()
        {
            InitializeComponent();
            this.Size = new System.Drawing.Size();
        }

        private void frmFetchingKR500_Load(object sender, EventArgs e)
        {
        ...
        private void frmFetchingKR500_Resize(object sender, EventArgs e)
        {
        ...
        private void frmFetchingKR500_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (e.CloseReason != CloseReason.UserClosing)
            {
                // Завершение
                FetchKR500Functions.StopFetch();
            }
            else
            {
                e.Cancel = true;
        ...
        private void Tuning()
        {
            using (frmTuningKR500 form = new frmTuningKR500())
            {
